...
impl DrawConfig {
    pub fn new(canvas_height: f32, config: &SurferConfig) -> Self {
        Self {
            ...
            max_transition_width: config.waves.max_transition_width,
...
impl State {
    ...
    fn draw_item_list(
        ...
        let cfg = DrawConfig::new(rect.size().y, &self.config);
        ...
        let rect = Rect {
            min: rect.min + Vec2::new(8.0, 0.0), // Margin, get from egui?
            max: rect.max,
        };
                ...
                ui.with_layout(
                    ...
                    |ui| {
                        ...
                        self.draw_background(
                            ...
                            waves,
                            Some(displayed_item),
                            next_y - 1.5 * ctx.cfg.line_height,
                            &ctx,
                            frame_width,
                        );
