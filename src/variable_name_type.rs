...
impl WaveData {
                ...
                DisplayedItem::Variable(variable) => {
                    ...
                    variable.display_name = match variable.display_name_type {
                        ...
                        VariableNameType::Unique => {
                            ...
                            fn unique(variable: &VariableRef, variables: &[VariableRef]) -> String {
                                ...
                                fn take_front(s: &VariableRef, l: usize) -> String {
                                    if l == 0 {
                                        s.name.clone()
                                    } else {
                                        format!(
    ...
    pub fn force_variable_name_type(&mut self, name_type: VariableNameType) {
        for variable in &mut self.displayed_items {
            if let DisplayedItem::Variable(variable) = variable {
