...
impl State {
    ...
    #[inline]
    pub fn get_show_statusbar(&self) -> bool {
        self.show_statusbar
    ...
    #[inline]
    pub fn get_show_overview(&self) -> bool {
        self.show_overview
            .unwrap_or_else(|| self.config.layout.show_overview())
    }

    #[inline]
    pub fn get_show_hierarchy(&self) -> bool {
        self.show_hierarchy
    ...
    #[inline]
    pub fn get_show_menu(&self) -> bool {
        self.show_menu
            .unwrap_or_else(|| self.config.layout.show_menu())
    }

    #[inline]
    pub fn get_show_variable_indices(&self) -> bool {
