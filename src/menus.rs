...
impl State {
    ...
    pub fn menu_contents(&self, ui: &mut Ui, msgs: &mut Vec<Message>) {
        ...
        ui.menu_button("Settings", |ui| {
            ...
            ui.radio(self.get_show_ticks(), "Show tick lines")
                .clicked()
                .then(|| {
                    ui.close_menu();
            ...
            ui.radio(self.get_show_tooltip(), "Show variable tooltip")
                .clicked()
                .then(|| {
                    ui.close_menu();
            ...
            ui.radio(self.get_show_variable_indices(), "Show variable indices")
                .clicked()
                .then(|| {
                    ui.close_menu();
